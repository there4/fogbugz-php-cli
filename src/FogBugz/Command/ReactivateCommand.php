...
class ReactivateCommand extends AuthCommand
{
    ...
    protected function configure()
    {
        $this
            ->setName('reactivate')
            ->setDescription('Reactivate a case. (The opposite of resolving a case)')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!is_numeric($case)) {
            ...
            if (empty($case)) {
                ...
                $output->writeln(
                    sprintf("<notice>Reactivating current Case %d.</notice>", $case),
        ...
        try {
            $this->app->fogbugz->reactivate($request);
            printf(
                "Reactivated case %s\n",
                $case
            );
...
/* End of file ReactivateCommand.php */
